...
echo
echo "Please enter the IP you will use to access beszel (leave blank to use $(hostname -I | awk '{print $1}')):" SERVER_IP
#read -r SERVER_IP
[ -z "$SERVER_IP" ] && SERVER_IP=$(hostname -I | awk '{print $1}')
echo
echo -s "Please enter the URL you will use to access beszel (leave blank to use $(hostname -f)):" ACCESS_URL
#read -r ACCESS_URL
