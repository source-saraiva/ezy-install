...
ports=(
  ...
  "80/tcp"      # HTTP (for proxy or certificate renewal)
  "67/udp"      # DHCP server (optional)
)

# Add ports permanently
for port in "${ports[@]}"; do
  echo "Adding port $port permanently..."
...
# Show active ports for confirmation
echo "Open ports:"
...
echo ""
echo "ezy-install just added firewall rules"
